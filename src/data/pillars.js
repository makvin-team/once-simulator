...
export const PILLARS = {
  aml: {
    ...
    modules: [
      { id: 'aml-m1', scenarioId: 'amlSuspiciousTransaction', durationMinutes: 12, locked: false, i18nKey: 'aml.m1' },
      { id: 'aml-m2', scenarioId: 'amlBeneficialOwner', durationMinutes: 10, locked: false, i18nKey: 'aml.m2' },
      { id: 'aml-m3', scenarioId: 'amlSanctions', durationMinutes: 10, locked: false, i18nKey: 'aml.m3' },
      { id: 'aml-m4', scenarioId: 'amlPep', durationMinutes: 8, locked: false, i18nKey: 'aml.m4' },
      { id: 'aml-m5', scenarioId: 'amlSarWriting', durationMinutes: 14, locked: false, i18nKey: 'aml.m5' },
    ],
  },
  cyber: {
    id: 'cyber',
    ...
    modules: [
      { id: 'cyber-m1', scenarioId: 'cyberPhishingTriage', durationMinutes: 10, locked: false, i18nKey: 'cyber.m1' },
      { id: 'cyber-m2', scenarioId: 'cyberSocTriage', durationMinutes: 12, locked: false, i18nKey: 'cyber.m2' },
      { id: 'cyber-m3', scenarioId: 'cyberIncidentResponse', durationMinutes: 15, locked: false, i18nKey: 'cyber.m3' },
      { id: 'cyber-m4', scenarioId: 'cyberZeroTrust', durationMinutes: 10, locked: false, i18nKey: 'cyber.m4' },
      { id: 'cyber-m5', scenarioId: 'cyberDeepfake', durationMinutes: 12, locked: false, i18nKey: 'cyber.m5' },
    ],
  },
  fraud: {
    id: 'fraud',
    ...
    modules: [
      { id: 'fraud-m1', scenarioId: 'fraudMuleAccount', durationMinutes: 9, locked: false, i18nKey: 'fraud.m1' },
      { id: 'fraud-m2', scenarioId: 'fraudSynthetic', durationMinutes: 11, locked: false, i18nKey: 'fraud.m2' },
      { id: 'fraud-m3', scenarioId: 'fraudSkimming', durationMinutes: 13, locked: false, i18nKey: 'fraud.m3' },
      { id: 'fraud-m4', scenarioId: 'fraudChargeback', durationMinutes: 9, locked: false, i18nKey: 'fraud.m4' },
      { id: 'fraud-m5', scenarioId: 'fraudAnomalyTuning', durationMinutes: 14, locked: false, i18nKey: 'fraud.m5' },
    ],
  },
  cx: {
    id: 'cx',
    ...
    modules: [
      { id: 'cx-m1', scenarioId: 'cxAddressChange', durationMinutes: 8, locked: false, i18nKey: 'cx.m1' },
      { id: 'cx-m2', scenarioId: 'cxAccountBlock', durationMinutes: 10, locked: false, i18nKey: 'cx.m2' },
      { id: 'cx-m3', scenarioId: 'cxAccessibility', durationMinutes: 8, locked: false, i18nKey: 'cx.m3' },
      { id: 'cx-m4', scenarioId: 'cxInternalEscalation', durationMinutes: 12, locked: false, i18nKey: 'cx.m4' },
      { id: 'cx-m5', scenarioId: 'cxComplexCustomer', durationMinutes: 10, locked: false, i18nKey: 'cx.m5' },
    ],
  },
};
