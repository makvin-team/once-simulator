...
const amlBeneficialOwner = {
  ...
  proctorIntro: 'Вы у консоли KYC. Поступил запрос на открытие корпоративного счёта — изучите ситуацию.',
  caseContext: {
    tag: 'Случай · консоль KYC · 10:10 вторник',
    context:
      'Вторник, 10:10. Вы — дежурный сотрудник KYC. Поступил запрос на открытие корпоративного счёта от «Konsalting Plus ООО» (ИНН 30412840100501). Представитель А. Назаров принёс документы, но отказывается раскрывать UBO (ultimate beneficial owner) — «это конфиденциально, мы покажем только управляющего». По регистрационным документам компания зарегистрирована в юрисдикции BVI, контролируется через три промежуточных слоя. Стартовый капитал — 5 млн USD. AML §5.1 требует: до открытия корпоративного счёта должен быть установлен конечный бенефициар, каждый слой собственности должен быть раскрыт.',
    whatYouSee: [
      'Организация: Konsalting Plus ООО · ИНН 30412840100501 · зарегистрирована в BVI.',
      'Структура владения: 3 промежуточных слоя · UBO скрыт · доверенность на А. Назарова.',
      'Стартовый капитал: 5 млн USD · источник не указан · процесс onboarding идёт 2 недели.',
    ],
    whatYouHear: [
      '«Это конфиденциальная информация, вы должны знать только управляющего.»',
      '«Документы пришлём позже, давайте сейчас откроем счёт.»',
    ],
    begin: 'Начать анализ',
  },
...
const amlSanctions = {
  ...
  proctorIntro: 'Вы у консоли платежей. Санкционный сканер выдал предупреждение — изучите ситуацию.',
  caseContext: {
    tag: 'Случай · сканер платежей · 13:10 четверг',
    context:
      'Четверг, 13:10. Вы — дежурный AML-аналитик платёжной консоли. Акмал Каримов (ИНН 30312840190303) запросил wire-перевод на 240 тыс. USD — получатель в Алматы. Санкционный сканер обнаружил 88% fuzzy-совпадение со списком OFAC SDN: имя и дата рождения получателя частично совпадают с лицом из санкционного перечня. Коридор UZ→KZ находится в high-risk перечне. AML §6.2 требует: при совпадении 80%+ транзакция немедленно блокируется и в течение 24 часов направляется отчёт OFAC. Прямого разговора с клиентом нет — это системно обнаруженная ситуация.',
    whatYouSee: [
      'Wire-запрос: 240 тыс. USD · получатель в Алматы · коридор UZ→KZ (high-risk).',
      'Санкционный сканер: 88% fuzzy-совпадение со списком OFAC SDN · имя и дата рождения совпадают.',
      'Клиент: Акмал Каримов · ИНН 30312840190303 · стандартный KYC пройден · клиент 3 года.',
    ],
    whatYouHear: [
      'Предупреждение сканера: «88% совпадение · OFAC SDN · решение остаётся за оператором».',
      'Никаких объяснений от клиента — платёж через канал ATM, разговора нет.',
    ],
    begin: 'Начать анализ',
  },
  proctorMicInstruction: 'Нажмите микрофон или выберите вариант.',
...
const amlPep = {
  ...
  proctorIntro: 'Вы у кассы. Клиент с PEP-меткой принёс крупный наличный приход — изучите ситуацию.',
  caseContext: {
    tag: 'Случай · касса филиала · 15:00 среда',
    context:
      'Среда, 15:00. Вы — дежурный сотрудник филиала Ташкент-1. К окну подходит Баходир Салимов (ИНН 30112840100210) — депутат региона, клиент 8 лет. Он хочет внести 420 млн сум как «бизнес-доход». В CRM-профиле клиента включён флаг PEP. Источник средств он указывает как «моя строительная компания» и предъявляет рабочий контракт, заключённый 2 месяца назад. AML §7.3 требует: для Politically Exposed Person стандартный KYC недостаточен — обязательны Enhanced Due Diligence и senior approval, при сумме 100 млн+ источник средств проверяется в полном объёме.',
    whatYouSee: [
      'Профиль: Баходир Салимов · ИНН 30112840100210 · депутат региона · флаг PEP · клиент 8 лет.',
      'Приход: 420 млн сум наличными · источник: «строительная компания» · контракт оформлен 2 месяца назад.',
      'Требование: AML §7.3 EDD обязателен · senior approval · документ источника проверяется.',
    ],
    whatYouHear: [
      '«Это доход моей строительной компании, документ при себе.»',
      '«Примите быстрее, я депутат, у меня времени нет.»',
    ],
    begin: 'Начать анализ',
  },
  proctorMicInstruction: 'Нажмите микрофон или выберите вариант.',
...
const amlSarWriting = {
  ...
  proctorIntro: 'Вы в редакторе SAR-черновика. Анализ завершён — нужно выбрать формат нарратива.',
  caseContext: {
    tag: 'Случай · редактор SAR · 11:30 пятница',
    context:
      'Пятница, 11:30. Вы — аналитик AML-команды. Завершился трёхнедельный анализ паттерна: 3 новых клиента (счета открыты 30–45 дней назад) совершили 4 транзакции на общую сумму более 156 млн сум наличного прихода, всё немедленно переведено на внешние карты. Доказательная база полная, нужно подготовить SAR-черновик для Compliance. AML §8.1 требует: фактический формат 5W (Кто, Что, Когда, Где, Сколько), нейтральный и профессиональный тон, без эмоций и обвинений. Compliance рассмотрит SAR в течение 24 часов и примет решение о подаче.',
    whatYouSee: [
      'Паттерн: 3 новых счёта (30–45 дней) · 4 транзакции · итого 156 млн сум наличного прихода.',
      'Направление: все средства немедленно переведены на внешние карты UnionPay (3 разные карты).',
      'Требование: фактический нарратив 5W · AML §8.1 · Compliance рассмотрит в течение 24 часов.',
    ],
    whatYouHear: [
      'Заметка от Compliance-менеджера: «без эмоций, только факт — каждое предложение с доказательством из аудита».',
      'AI-помощник: «паттерн чёткий, доказательства полные — можно начинать черновик».',
    ],
    begin: 'Начать анализ',
  },
  proctorMicInstruction: 'Нажмите микрофон или выберите вариант.',
...
const cyberSocTriage = {
  ...
  proctorIntro: 'Вы у консоли SOC. IDS выдал критическое предупреждение — изучите ситуацию.',
  caseContext: {
    tag: 'Случай · консоль SOC · 09:34 вторник',
    context:
      'Вторник, 09:34. Вы — дежурный SOC-аналитик. IDS выдал критическое предупреждение: рабочая станция FIN-WS-12 (Win11, в домене) финансового отдела сделала несанкционированную попытку доступа к admin$ share, а затем начала SMB-сканирование соседнего хоста. Пользователь нормально вошёл в 09:14, через 18 минут начался паттерн. Это классический признак lateral movement — операторы ransomware обычно так распространяются по сети. IR-команда в режиме stand-by, кнопка изоляции у вас на консоли.',
    whatYouSee: [
      'Хост: FIN-WS-12 · финансовый отдел · Win11 · в домене · последний вход 09:14.',
      'Паттерн: попытка admin$ share + SMB-скан соседнего хоста · IDS critical alert · 09:32–09:34.',
      'Сеть: 1 подозрительный хост · резервные сети пока чистые · IR-команда stand-by.',
    ],
    whatYouHear: [
      'Сообщение IDS: «critical alert · admin$ share access attempt · 1 host · паттерн lateral movement».',
      'Шёпот руководителя IR: «ждём или изолируем — решение за вами».',
    ],
    begin: 'Начать анализ',
  },
  proctorMicInstruction: 'Нажмите микрофон или выберите вариант.',
...
const cyberIncidentResponse = {
  ...
  proctorIntro: 'Вы в IR command center. Идёт активная атака ransomware — каждая секунда важна.',
  caseContext: {
    tag: 'Случай · IR command center · 14:46 среда',
    context:
      'Среда, 14:46. Вы — руководитель команды Incident Response. 14 минут назад (в 14:32) первый хост финансового отдела был зашифрован вариантом ransomware Lockbit. На текущий момент заражены 8 хостов, только что появилось требование выкупа — 50 BTC (≈ 1,5 млн USD). Резервная сеть физически изолирована и пока чиста, но если инкубация продолжится, под угрозой окажется и она. Протокол NIST 800-61 чётко определяет: сначала Containment, потом Eradication, потом Recovery — сохранить forensic-доказательства обязательно.',
    whatYouSee: [
      'Распространение: 8 хостов зашифровано · все в финансовом отделе · за 14 минут (14:32 → 14:46).',
      'Ransomware: вариант Lockbit · требование 50 BTC (≈ 1,5 млн USD) · указан BTC-адрес.',
      'Резерв: физически изолированная сеть · пока чиста · при задержке может быть заражена.',
    ],
    whatYouHear: [
      'Шёпот CTO: «сохраните forensic — нужно для страховки и следствия».',
      'Junior IR: «давайте быстро восстановим из резерва, времени же нет?»',
    ],
    begin: 'Начать анализ',
  },
  proctorMicInstruction: 'Нажмите микрофон или выберите вариант.',
...
const cyberZeroTrust = {
  ...
  proctorIntro: 'Вы у консоли IAM. Внешний вендор просит admin-права — изучите ситуацию.',
  caseContext: {
    tag: 'Случай · консоль IAM · 10:12 четверг',
    context:
      'Четверг, 10:12. Вы — дежурный инженер IAM (Identity and Access Management). Внешний вендор — «TechVendor LLC» (договор 2 года, 6 инженеров) — запросил постоянный admin-доступ к production-окружению. Представитель объясняет это «постоянным техническим обслуживанием»: они каждый день проводят технический осмотр и должны иметь возможность срочно подключиться. Наша стратегия Zero Trust зафиксирована в IB-505: ко всякому запросу относиться с подозрением, принцип минимальных привилегий. Система JIT (Just-In-Time) access готова: 4-часовые окна, подтверждение каждой сессии, журнал, автоматический отзыв после сессии.',
    whatYouSee: [
      'Запрашивающий: TechVendor LLC · внешний подрядчик · договор 2 года · 6 инженеров.',
      'Запрос: production admin · постоянное подключение · обоснование «постоянное техобслуживание».',
      'Доступно: система JIT · 4-часовые окна · подтверждение + журнал · автоматический отзыв.',
    ],
    whatYouHear: [
      'Представитель вендора: «постоянное подключение упростит срочное реагирование».',
      'Заметка CISO: «если взломан вендор — будем взломаны и мы, это supply chain-риск».',
    ],
    begin: 'Начать анализ',
  },
  proctorMicInstruction: 'Нажмите микрофон или выберите вариант.',
...
const cyberDeepfake = {
  ...
  proctorIntro: 'Вы за столом Treasury-оператора. «CEO» просит срочный wire — голос подозрительный.',
  caseContext: {
    tag: 'Случай · Treasury-оператор · 16:04 пятница',
    context:
      'Пятница, 16:04. Вы — Treasury-оператор, последний рабочий день недели. С незнакомого номера пришёл звонок: голос похож на CEO Акмала Турсунова, но немного uncanny — паузы между словами неестественны, интонация странная. Он просит срочный wire-перевод на 200 тыс. USD — «пока сделка не сорвалась, я сейчас в аэропорту, документ пришлю позже». За последние 6 месяцев в банковском секторе зафиксировано 4 похожих deepfake-атаки. Протокол IB-606 обязателен: для крупных wire-запросов — callback на известный номер CEO. На экране у вас официальный номер CEO и записывающее устройство сессии.',
    whatYouSee: [
      'Звонок: с незнакомого номера · идёт 4 минуты · представился «CEO Акмал Турсунов».',
      'Голос: uncanny (странные паузы, неестественная интонация) · высокий признак deepfake.',
      'Запрос: 200 тыс. USD wire · немедленно · «пока сделка не сорвалась» · документ позже.',
    ],
    whatYouHear: [
      '«Сделайте wire прямо сейчас, пока сделка не сорвалась. Я сейчас в аэропорту.»',
      '«Документ пришлю позже, сейчас нет времени на подтверждение, доверьтесь мне.»',
    ],
    begin: 'Начать анализ',
  },
  proctorMicInstruction: 'Нажмите микрофон или выберите вариант.',
...
const fraudSynthetic = {
  ...
  proctorIntro: 'Вы у консоли онбординга. В запросе появился признак composite ID — изучите ситуацию.',
  caseContext: {
    tag: 'Случай · консоль онбординга · 09:23 понедельник',
    context:
      'Понедельник, 09:23. Вы — дежурный аналитик онлайн-онбординга. Через мобильное приложение пришёл запрос на открытие счёта на имя «Рустам Ахмедов». Проверка ID показала любопытное: указанный ИНН подлинный и есть в государственной базе — но это имя с этим ИНН появилось впервые. Регистрационный адрес за последние 6 месяцев связан с 3 разными flagged-счетами. Credit file thin (только что создан). Главное — device fingerprint совпадает с устройством, на котором ранее открывались другие flagged-счета. Это классический признак synthetic identity: composite-личность собрана из реальных данных, подготовлена под mule- или credit-fraud-схему.',
    whatYouSee: [
      'ID: указанный ИНН подлинный · имя с этим ИНН вводится впервые · composite.',
      'Адрес: за 6 месяцев связан с 3 разными flagged-счетами · все подозревались в mule-схеме.',
      'Device fingerprint: повторный · совпадает с открытием 5 других счетов · признак фермы.',
    ],
    whatYouHear: [
      'Бот онбординга: «запрос на подтверждение · решение за оператором».',
      'Fraud-монитор: «совпадение device fingerprint · cluster id 3 · composite ID помечен · рекомендуется пауза онбординга».',
    ],
    begin: 'Начать анализ',
  },
  proctorMicInstruction: 'Нажмите микрофон или выберите вариант.',
...
const fraudSkimming = {
  ...
  proctorIntro: 'Вы у карт-монитора. Система обнаружила geo velocity-аномалию — изучите ситуацию.',
  caseContext: {
    tag: 'Случай · карт-монитор · 14:08 пятница',
    context:
      'Пятница, 14:08. Вы — дежурный fraud-аналитик. Система выдала предупреждение по Premium-карте 4188…7733 (владелец Дониёр Рашидов, клиент 3 года): карта использована в 13:45 на банкомате в Ташкенте — снятие 500 тыс. сум, затем в 14:07 на банкомате в Самарканде — ещё 500 тыс. сум. Расстояние 280 км за 22 минуты — физически невозможно. Оба банкомата принадлежат связанному географическому кластеру (за последние 30 дней через этот кластер прошло 8 подозрительных карт). Ошибки CVV по другим картам также участились. Классический признак ATM-скимминга + clone.',
    whatYouSee: [
      'Карта: 4188…7733 · Дониёр Рашидов · Premium · 3 года · последнее нормальное использование вчера.',
      'Velocity: Ташкент 13:45 (500K сум) → Самарканд 14:07 (500K сум) · 280 км · 22 минуты.',
      'Cluster: оба банкомата связаны · 30 дней · 8 подозрительных карт · ошибки CVV участились.',
    ],
    whatYouHear: [
      'Fraud-бот: «нарушение geo velocity · 280 км / 22 мин · физически невозможно».',
      'ATM-оператив (телефон): «На самаркандском устройстве найдена подозрительная накладка — идёт техническая проверка».',
    ],
    begin: 'Начать анализ',
  },
  proctorMicInstruction: 'Нажмите микрофон или выберите вариант.',
...
const fraudChargeback = {
  ...
  proctorIntro: 'Вы у консоли chargeback. Поступил новый спор — изучите ситуацию.',
  caseContext: {
    tag: 'Случай · консоль chargeback · 10:30 вторник',
    context:
      'Вторник, 10:30. Вы — дежурный chargeback-аналитик. Клиент Озода Юсупова (клиент 4 года, Premium-карта) открыла chargeback по reason code 4855 («товар не получен») на сумму 1240 USD за покупку электроники. 5 дней назад клиент совершила эту покупку в онлайн-магазине UnionMall, billing-адрес — её зарегистрированный. 4 дня назад курьерская служба доставила посылку, в подписи стоит «O. Юсупова» — в трекинговой системе есть фото и GPS-координаты. Главное: за последние 12 месяцев у клиента уже 11 chargeback, почти по одному каждый месяц. Это классическая схема friendly fraud (chargeback misuse). По правилам Visa защитные доказательства нужно подать в течение 5 дней.',
    whatYouSee: [
      'Клиент: Озода Юсупова · клиент 4 года · Premium-карта · NPS 6,8 (средний).',
      'Покупка: $1240 электроника · онлайн-магазин UnionMall · billing = зарегистрированный адрес · 5 дней назад.',
      'История: за последние 12 месяцев 11 chargeback · почти каждый месяц · все по reason 4855.',
    ],
    whatYouHear: [
      'Клиент в форме chargeback: «Товар не пришёл, я ничего не получала.»',
      'Трекинг: «Посылка доставлена · подпись: O. Юсупова · GPS совпадает с billing · время 14:22».',
    ],
    begin: 'Начать анализ',
  },
  proctorMicInstruction: 'Нажмите микрофон или выберите вариант.',
...
const fraudAnomalyTuning = {
  ...
  proctorIntro: 'Вы у консоли управления моделью. Обнаружен drift velocity-правила — изучите ситуацию.',
  caseContext: {
    tag: 'Случай · управление моделью · 11:30 среда',
    context:
      'Среда, 11:30. Вы — инженер моделей в команде Fraud AI. Velocity-правило v3.4 (запущено 11 месяцев назад) последние 3 недели ведёт себя нестабильно: уровень ложных срабатываний (FP rate) в 4,2 раза выше нормы. Причина выявлена — в Ташкентском регионе зарплатный день для госсектора был сдвинут с 25-го на 5-е число месяца 3 недели назад. Это ломает прежнюю velocity-норму. Система backtest готова: есть 6 месяцев исторических данных, можно провести hold-out-проверку. Coverage сейчас 92% — при тюнинге важно его не уронить. Изменение модели — критично для всей системы обнаружения fraud в банке.',
    whatYouSee: [
      'Модель: velocity-правило v3.4 · работает 11 месяцев · drift начался 3 недели назад.',
      'FP rate: 4,2× от нормы · причина структурная: payday в Ташкенте перенесён с 25-го на 5-е.',
      'Backtest: 6 месяцев исторических данных доступны · coverage сейчас 92% (нужно сохранить).',
    ],
    whatYouHear: [
      'Fraud-менеджер: «правьте модель срочно, но coverage не уроните — мы не хотим пропускать fraud».',
      'Junior data scientist: «может, отключим правило вообще? FP-rate ведь очень высокий».',
    ],
    begin: 'Начать анализ',
  },
  proctorMicInstruction: 'Нажмите микрофон или выберите вариант.',
...
const cxAccountBlock = {
  ...
  proctorIntro: 'Вы дежурный Premium-линии. Поступил нервный звонок от клиента — изучите ситуацию.',
  caseContext: {
    tag: 'Случай · Premium support · 07:42 вторник',
    context:
      'Вторник, 07:42 утра. Вы — дежурный Premium-линии поддержки. Звонит Дилфуза Юсупова, клиент 5,4 года, NPS 9,4. Вчера ночью velocity-правило заблокировало её карту после 5 транзакций — все соответствуют её профилю и привычным тратам, классический false positive. SMS-уведомление ушло, но клиент спала и не увидела. Сейчас до самолёта 90 минут, клиент нервничает, повышает голос. Скор fraud-риска низкий — профиль соответствует.',
    whatYouSee: [
      'CRM: Дилфуза Юсупова · Premium · 5,4 года · NPS 9,4 · 0 chargeback за последний год.',
      'Причина блока: velocity rule (5 транзакций за 12 мин) · профиль соответствует · fraud-риск низкий.',
      'Давление времени: до самолёта 90 минут · рейс в Дубай · супервайзер on-call.',
    ],
    whatYouHear: [
      '«Карта не работает, я в аэропорту — вы у меня деньги украли?»',
      '«Я уже 5 лет ваш клиент, что это вообще такое?»',
    ],
    begin: 'Начать анализ',
  },
  proctorMicInstruction: 'Нажмите микрофон или выберите вариант.',
...
const cxAccessibility = {
  ...
  proctorIntro: 'Вы у линии accessibility-поддержки. Поступил вызов — изучите ситуацию.',
  caseContext: {
    tag: 'Случай · Accessibility-помощь · 10:18 понедельник',
    context:
      'Понедельник, 10:18. Вы — дежурный по линии accessibility-поддержки. Звонит Мурод Рахимов (ИНН 30412840290007), наш клиент 4,1 года. Он потерял зрение, работает через screen-reader NVDA. На новом интерфейсе онлайн-банкинга страница перевода непригодна: у кнопок нет ARIA-меток, балансовый текст не помечен alt-text, кнопка «Подтвердить» не находится экранным считывателем. Клиент уже 25 минут крутится по странице, в голосе слышна усталость. Наш Accessibility manual §3 требует: полная сессия с сопровождением + закладки на accessible-маршруты.',
    whatYouSee: [
      'CRM: Мурод Рахимов · ИНН 30412840290007 · 4,1 года клиент · accessibility-флаг: зрение.',
      'Продукт: новый онлайн-банкинг (v3.2) · ARIA-аудит ещё не пройден · совместимость с экранным считывателем низкая.',
      'История сессии: последние 25 минут · 7 неуспешных попыток · последняя страница "transfer/confirm".',
    ],
    whatYouHear: [
      '«Не могу найти кнопку «Подтвердить», страница не работает со screen-reader.»',
      '«В прошлой версии я справлялся сам, теперь нужна помощь — это несправедливо.»',
    ],
    begin: 'Начать анализ',
  },
  proctorMicInstruction: 'Нажмите микрофон или выберите вариант.',
  ...
  actions: {
    ...
    standardTutorial: 'Стандартное обучение', standardTutorialHint: 'Не подходит под экранный считыватель · проблема навигации',
  ...
  proctorFeedback: {
    ...
    partial: 'Стандартное обучение не подходит под экранный считыватель. Клиент перезвонит.',
  ...
  screen: {
    ...
    endPartial: { title: 'Стандартное обучение', subtitle: 'Ограниченная помощь · возможен повторный звонок' },
    endFail: {
...
const cxInternalEscalation = {
  ...
  proctorIntro: 'Вы — senior CX. Пришёл внутренний SOS от junior — изучите ситуацию.',
  caseContext: {
    tag: 'Случай · Внутренний SOS · 15:32 среда',
    context:
      'Среда, 15:32. Вы — senior-консультант CX-команды. Поступил внутренний SOS — junior agent Азиз Каримов (стаж 3 недели) замер на линии. Клиент — представитель корпоративного клиента «Soylama Ltd», 14 лет в банке, в последние 6 месяцев 3 жалобы. Клиент говорит на повышенных тонах, использует мат. Junior молчит, физическая реакция: пульс 124, руки трясутся. Очередь — 4 вызова ожидают. Протокол CX-440: take-over + coach.',
    whatYouSee: [
      'Экран junior: Азиз Каримов · стаж 3 недели · пульс 124 · режим шёпота активен.',
      'Клиент: представитель Soylama Ltd · 14 лет · 3 жалобы за 6 месяцев · чувствителен к NPS.',
      'Команда: 4 вызова ожидают · senior-менеджер вне офиса · ваша очередь.',
    ],
    whatYouHear: [
      '«Тут вообще кто работает? Ты говорить умеешь?!»',
      'Junior в канал шёпота: «Senior, я не знаю что делать... я новичок.»',
    ],
    begin: 'Начать анализ',
  },
  proctorMicInstruction: 'Нажмите микрофон или выберите вариант.',
...
const cxComplexCustomer = {
  ...
  proctorIntro: 'Вы дежурный Premium-линии. Поступил комплексный запрос от долгосрочного клиента — изучите ситуацию.',
  caseContext: {
    tag: 'Случай · Premium support · 11:15 пятница',
    context:
      'Пятница, 11:15. Вы — дежурный Premium-линии поддержки. Звонит Зафар Каримов, наш клиент 8,7 лет, NPS 9,6. У него 5 активных продуктов в банке: депозит, ипотека, кредитка, брокерский счёт, страховка. На счёте оформлены 3 члена семьи как представители. В одном звонке он поднимает 3 больших запроса: (1) единый ежемесячный statement по всем 5 продуктам; (2) пересмотр ставки по ипотеке (взята 2 года назад под 17%); (3) смена бенефициара на брокерском счёте (отец скончался). Каждый запрос относится к отдельному подразделению, каждый занимает 15–20 минут. Клиент говорит спокойно, но усталым тоном.',
    whatYouSee: [
      'CRM: Зафар Каримов · ИНН 30412840190201 · Premium · 8,7 лет · NPS 9,6 · 5 продуктов.',
      'Запросы: (a) консолидированный statement, (b) пересмотр ставки по ипотеке, (c) смена бенефициара.',
      'Профиль: 5 продуктов · 3 семейных представителя · последний звонок 90 дней назад.',
    ],
    whatYouHear: [
      '«Давайте решим всё за один звонок, у меня очень мало времени.»',
      '«Отец скончался, нужно сменить бенефициара на брокерском — остальное тоже одновременно.»',
    ],
    begin: 'Начать анализ',
  },
  proctorMicInstruction: 'Нажмите микрофон или выберите вариант.',
