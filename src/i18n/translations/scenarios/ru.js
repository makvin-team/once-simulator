...
const cxAccessibility = {
  ...
  caseContext: {
    ...
    whatYouSee: [
      ...
      'Продукт: новый online-банкинг (v3.2) · ARIA-аудит ещё не пройден · совместимость со screen-reader низкая.',
...
const cxInternalEscalation = {
  ...
  caseContext: {
    ...
    whatYouSee: [
      'Экран junior: Азиз Каримов · стаж 3 недели · pulse monitor 124 · whisper-mode активен.',
      'Клиент: представитель Soylama Ltd · 14 лет · 3 жалобы за 6 месяцев · чувствителен к NPS.',
      'Команда: 4 вызова ожидают · senior-менеджер off-site · ваша очередь.',
    ],
    whatYouHear: [
      '«Тут вообще кто работает? Ты говорить умеешь?!»',
      'Junior в whisper-канал: «Senior, я не знаю что делать... я новичок.»',
    ],
    begin: 'Начать анализ',
  },
  proctorMicInstruction: 'Нажмите микрофон или выберите вариант.',
