...
const cxInternalEscalation = {
  ...
  caseContext: {
    ...
    whatYouSee: [
      'Junior agent экрани: Азиз Каримов · 3 ҳафта стаж · pulse monitor 124 · whisper mode актив.',
      'Мижоз: Soylama Ltd вакили · 14 йил мижоз · 6 ойда 3 шикоят · NPS сезгиси юқори.',
      'Жамоа: 4 та call кутмоқда · senior manager off-site · сизнинг навбатингиз.',
    ],
    whatYouHear: [
      '«Бу ерда ким ишлаяпти? Сен умуман гапира оласизми?!»',
      'Junior whisper-channel: «Senior, мен нима қилишни билмаяпман... мен янгиман.»',
    ],
    begin: 'Таҳлилни бошлаш',
  },
  proctorMicInstruction: 'Микрофонни босинг ёки танловни босинг.',
